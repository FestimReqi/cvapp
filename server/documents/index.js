module.exports = ({
  ...
  return `
        ...
        <html>
            <head>
                <!-- Font Awesome -->
                <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.0.0/css/all.css"> <!-- Update to the latest version -->
                <!-- Bootstrap core CSS -->
                <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.3.0/css/bootstrap.min.css" rel="stylesheet"> <!-- Update to the latest version -->
                <!-- Material Design Bootstrap -->
                <link href="https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/6.0.0/css/mdb.min.css" rel="stylesheet"> <!-- Update to the latest version -->
                ...
                <style>
                  ...
                  body{
                    font-family: 'Garamond'; /* Consider using a more common font or include a web-safe font as a backup */
                  }
                </style>
