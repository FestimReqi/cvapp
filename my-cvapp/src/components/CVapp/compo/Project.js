        ...
        <form onSubmit={this.continue}>
          <div className="row col-lg-10 mx-auto">
            ...
            <div className="col-lg-6 text-left">
              <label htmlFor="proj1_title">Title*</label>
              <input
                type="text"
                name="proj1_title"
            ...
            <div className="col-lg-6 text-left">
              <label htmlFor="proj1_link">Link</label>
              <input
                type="text"
                name="proj1_link"
                className="form-control"
          ...
          <div className="row col-lg-10 mx-auto">
            <div className="col-lg-12 text-left">
              <label htmlFor="proj1_desc">Description*</label>
              <input
                type="text"
                name="proj1_desc"
                className="form-control"
          ...
          <div className="row col-lg-10 mx-auto">
            ...
            <div className="col-lg-6 text-left">
              <label htmlFor="proj2_title">Title*</label>
              <input
                type="text"
                name="proj2_title"
                className="form-control"
            ...
            <div className="col-lg-6 text-left">
              <label htmlFor="proj2_link">Link</label>
              <input
                type="text"
                name="proj2_link"
                className="form-control"
          ...
          <div className="row col-lg-10 mx-auto">
            <div className="col-lg-12 text-left">
              <label htmlFor="proj2_desc">Description*</label>
              <input
                type="text"
                name="proj2_desc"
                className="form-control"
