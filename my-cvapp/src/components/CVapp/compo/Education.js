        ...
        <form onSubmit={this.continue}>
          <div className="row col-lg-10 mx-auto">
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="edu1_school">College/University*</label>
              <input
                type="text"
                name="edu1_school"
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="edu1_year">Year*</label>
              <input
                type="text"
                name="edu1_year"
                className="form-control"
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="edu1_qualification">Qualification*</label>
              <input
                type="text"
          ...
          <div className="row col-lg-10 mx-auto">
            <div className="col-lg-12 text-left">
              <label htmlFor="edu1_desc">Description*</label>
              <input
                type="text"
                name="edu1_desc"
                className="form-control"
          ...
          <div className="row col-lg-10 mx-auto">
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="edu2_school">School</label>
              <input
                type="text"
                name="edu2_school"
                className="form-control"
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="edu2_year">Year</label>
              <input
                type="text"
                name="edu2_year"
                className="form-control"
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="edu2_qualification">Qualification</label>
              <input
                type="text"
          ...
          <div className="row col-lg-10 mx-auto">
            <div className="col-lg-12 text-left">
              <label htmlFor="edu2_desc">Description</label>
              <input
                type="text"
                name="edu2_desc"
                className="form-control"
