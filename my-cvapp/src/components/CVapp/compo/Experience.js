        ...
        <form onSubmit={this.continue}>
          <div className="row col-lg-10 mx-auto">
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="exp1_org">Institute/Organisation*</label>
              <input
                type="text"
                name="exp1_org"
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="exp1_pos">Position*</label>
              <input
                type="text"
                name="exp1_pos"
                className="form-control"
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="exp1_dur">Duration*</label>
              <input
                type="text"
                name="exp1_dur"
                className="form-control"
          ...
          <div className="row col-lg-10 mx-auto">
            <div className="col-lg-12 text-left">
              <label htmlFor="exp1_desc">Description*</label>
              <input
                type="text"
                name="exp1_desc"
                className="form-control"
          ...
          <div className="row col-lg-10 mx-auto">
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="exp2_org">Institute/Organisation*</label>
              <input
                type="text"
                name="exp2_org"
                className="form-control"
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="exp2_pos">Position*</label>
              <input
                type="text"
                name="exp2_pos"
                className="form-control"
            ...
            <div className="col-lg-4 text-left">
              <label htmlFor="exp2_dur">Duration*</label>
              <input
                type="text"
                name="exp2_dur"
                className="form-control"
          ...
          <div className="row col-lg-10 mx-auto">
            <div className="col-lg-12 text-left">
              <label htmlFor="exp2_desc">Description*</label>
              <input
                type="text"
                name="exp2_desc"
                className="form-control"
